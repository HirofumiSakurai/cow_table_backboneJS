...
define('text!templates/cow_number.html',[],function () { return '<div class="cow-number"><%- ear_num %></a>\n';});

define('views/cow_number',[
    'jquery', 
    'underscore', 
    'backbone',
...
(function(factory){
	if(typeof define === 'function' && define.amd){
		define('jqueryNumeric',['jquery'], factory);
	}else{
...
define('text!templates/ai_log_item.html',[],function () { return '<div> <div class="ai-log-item"><%- date %>:<%- state %></div></div>\n';});

define('views/ai_log_item',[
    'jquery', 
    'underscore', 
    'backbone',
...
define('text!templates/aiLogShow.html',[],function () { return '<h1>AIログ</h1>\n\n<div id="log">\n  <ul">\n      <li>耳標番号:<%- cow_no %></li>\n      <li>日付:<%- date %>"</li>\n      <li>状態:<%- state %>"</li>\n  </ul>\n</div>\n<div id="buttons"></dev>\n\n';});


define('text!templates/aiLogEdit.html',[],function () { return '<h1>AIログ</h1>\n\n<div id="log">\n  <ul">\n      <li>耳標番号:<%- cow_no %></li>\n      <li><input id="date" type="date" value="<%- date %>"/></li>\n      <li><input id="state" placeholder="" type="text" value="<%- state %>"/></li>\n  </ul>\n</div>\n<div id="buttons"></dev>\n\n';});
...
;
define("dualstorage", function(){});

define('collection/kine',[
    'underscore',
    'backbone',
    'dualstorage',
    'models/cow'
