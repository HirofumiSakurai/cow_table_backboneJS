...
var underscore, jquery, backbone, global, text_templates_cow_numberhtml, views_cow_number, text_templates_kinehtml, text_templates_kineLhtml, jqueryNumeric, views_kine, text_templates_cowhtml, text_templates_cowEhtml, text_templates_daughterhtml, models_cow, models_aiLog, text_templates_ai_log_itemhtml, views_ai_log_item, text_templates_aiLogShowhtml, text_templates_aiLogEdithtml, views_aiLog, views_cow, dualstorage, collection_kine, collection_aiLogs, models_daughter, collection_daughters, routers_router, mainsimple, _text_;
(function () {
  // Baseline setup
  // --------------
...
text_templates_cow_numberhtml = '<div class="cow-number"><%- ear_num %></a>\n';
views_cow_number = function ($, _, Backbone, cowNumberTemplate) {
  var CowNumberView = Backbone.View.extend({
    tagName: 'li',
    className: 'cow-number',
    template: _.template(cowNumberTemplate),
    events: { 'click .cow-number': 'navi2cow' },
    initialize: function () {
    },
    render: function () {
...
}(jquery, underscore, backbone, text_templates_cow_numberhtml);
text_templates_kinehtml = '<h1>\u725B\u7FA4\u7BA1\u7406</h1>\n\n<div id="kine">\n  owner ID: <%- owner_id %>\n  <input type="button" value="\u725B\u30C7\u30FC\u30BF\u4F5C\u6210" id = "createCow"/>\n  <p />\n  \n  <ul id="cow-list" class="cow-list"></ul>\n</div>\n\n';
text_templates_kineLhtml = '<h1>\u725B\u7FA4\u7BA1\u7406</h1>\n\n<div id="kine">\n  owner ID:\n  <input id="owner_id" placeholder="owner id : 1 - 160[Enter]" type="text" />\n  <p></p>\n  <ul id="cow-list" class="cow-list"></ul>\n</div>\n\n';
/*
 *
...
views_kine = function ($, _, Backbone, CowNumberView, kineTemplate, loginTemplate) {
  var KineView = Backbone.View.extend({
    ...
    renderCowNumber: function () {
      this.$('#cow-list').html('');
      this.view_list = [];
      _.each(this.kineCollection.models, function (cow) {
        if (cow) {
          var view = new CowNumberView({ model: cow }, this);
    ...
    searchOnEnter: function (e) {
      ...
      this.$('#cow-list').html('<font color="skyblue">\u304A\u5F85\u3061\u304F\u3060\u3055\u3044\u3002</font>');
      this.navigate('next', '');
    },
    ...
    remove: function () {
      _.each(this.view_list, function (v) {
        v.remove();
      });
  ...
  return KineView;
}(jquery, underscore, backbone, views_cow_number, text_templates_kinehtml, text_templates_kineLhtml);
text_templates_cowhtml = '<div id="button"></div><p />\n<ul id="cow-p-entity">\n  <li>\n    <div class="cow-p-tag">\u8033\u6A19\u756A\u53F7:</div>\n    <div class="cow-p-ent"><%- ear_num %></div>\n  </li>\n  <li>\n    <div class="cow-p-tag">\u540D\u524D:</div>\n    <div class="cow-p-ent"><%- name %></div>\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6027\u5225:</div>\n    <div class="cow-p-ent"><%- sex %></div>\n  </li>\n  <li>\n    <div class="cow-p-tag">\u51FA\u751F\u65E5:</div>\n    <div class="cow-p-ent"><%- birth %></div>\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6240\u6709\u8005ID:</div>\n    <div class="cow-p-ent"><%- owner_id %></div>\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6BCD\u89AAID:</div>\n    <div class="cow-p-ent"><%- parent %></div>\n  </li>\n</ul><p />\n\n<div id="cow-daughter-tag">\u5A18\u725B\u30EA\u30B9\u30C8</div>\n<ul id="daughter-list"></ul>\n<p />\n\n<div id="cow-ai-tag">\u4EBA\u53E3\u53D7\u7CBE\u8A18\u9332\n  <input type="button" id="create-ai-log" value="\u65B0\u898F\u8A18\u9332" />\n</div>\n\n<ul id="ai-log-list"></ul>\n<p />\n\n</ul>\n\n<div id="additional">\n<p> t1:<%- t1 %>,t2:<%- t2 %>,t3:<%- t3 %>,t4:<%- t4 %>,t5:<%- t5 %>,\nt6:<%- t6 %>,t7:<%- t7 %>,t8:<%- t8 %>,t9:<%- t9 %>,t10:<%- t10 %> </p>\n<p> t11:<%- t11 %>,t12:<%- t12 %>,t13:<%- t13 %>,t14:<%- t14 %>,t15:<%- t15 %>,\nt16:<%- t16 %>,t17:<%- t17 %>,t18:<%- t18 %>,t19:<%- t19 %>,t20:<%- t20 %> </p>\n<p> t21:<%- t21 %>,t22:<%- t22 %>,t23:<%- t23 %>,t24:<%- t24 %>,t25:<%- t25 %>,\nt26:<%- t26 %>,t27:<%- t27 %>,t28:<%- t28 %>,t29:<%- t29 %>,t30:<%- t30 %> </p>\n<p> t31:<%- t31 %>,t32:<%- t32 %>,t33:<%- t33 %>,t34:<%- t34 %>,t35:<%- t35 %>,\nt36:<%- t36 %>,t37:<%- t37 %>,t38:<%- t38 %>,t39:<%- t39 %>,t40:<%- t40 %> </p>\n<p> t41:<%- t41 %>,t42:<%- t42 %>,t43:<%- t43 %>,t44:<%- t44 %>,t45:<%- t45 %>,\nt46:<%- t46 %>,t47:<%- t47 %>,t48:<%- t48 %>,t49:<%- t49 %>,t50:<%- t50 %> </p>\n</div>\n';
text_templates_cowEhtml = '<div id="button">\n    <input type="button" value="\u4FDD\u5B58" id="save"/>\n    <input type="button" value="\u53D6\u308A\u6D88\u3057" id="cancel" />\n</div>\n<ul id="cow-p-entity">\n  <li>\n    <div class="cow-p-tag">\u8033\u6A19\u756A\u53F7:</div>\n    <input class="cow-p-ent" value="<%- ear_num %>" id="ear_num" />\n  </li>\n  <li>\n    <div class="cow-p-tag">\u540D\u524D:</div>\n    <input class="cow-p-ent" value="<%- name %>" id="name" />\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6027\u5225:</div>\n    <input type="radio" name="sex" class="cow-p-ent" id="sex-female" <% print((sex==="\u96CC")?"checked":"") %> />\u96CC\n    <input type="radio" name="sex" class="cow-p-ent" id="sex-male" <% print((sex==="\u96C4")?"checked":"") %> />\u96C4\n  </li>\n  <li>\n    <div class="cow-p-tag">\u51FA\u751F\u65E5:</div>\n    <input type="date" class="cow-p-ent" value="<%- birth %>" id="birth" />\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6BCD\u89AAID:</div>\n    <input class="cow-p-ent" value="<%- parent %>" id="parent" />\n  </li>\n  <li>\n    <div class="cow-p-tag">\u6240\u6709\u8005ID: <%- owner_id %> </div>\n  </li>\n</ul><p />\n\n<div id="additional">\n    <div> t1:<input class="tinp" value="<%- t1 %>" id="t1" /> </div>\n    <div> t2:<input class="tinp" value="<%- t2 %>" id="t2" /> </div>\n    <div> t3:<input class="tinp" value="<%- t3 %>" id="t3" /> </div>\n    <div> t4:<input class="tinp" value="<%- t4 %>" id="t4" /> </div>\n    <div> t5:<input class="tinp" value="<%- t5 %>" id="t5" /> </div>\n\n    <div> t6:<input class="tinp" value="<%- t6 %>" id="t6" /> </div>\n    <div> t7:<input class="tinp" value="<%- t7 %>" id="t7" /> </div>\n    <div> t8:<input class="tinp" value="<%- t8 %>" id="t8" /> </div>\n    <div> t9:<input class="tinp" value="<%- t9 %>" id="t9" /> </div>\n    <div> t10:<input class="tinp" value="<%- t10 %>" id="t10" /> </div>\n    <p />\n\n    <div> t11:<input class="tinp" value="<%- t11 %>" id="t11" /> </div>\n    <div> t12:<input class="tinp" value="<%- t12 %>" id="t12" /> </div>\n    <div> t13:<input class="tinp" value="<%- t13 %>" id="t13" /> </div>\n    <div> t14:<input class="tinp" value="<%- t14 %>" id="t14" /> </div>\n    <div> t15:<input class="tinp" value="<%- t15 %>" id="t15" /> </div>\n\n    <div> t16:<input class="tinp" value="<%- t16 %>" id="t16" /> </div>\n    <div> t17:<input class="tinp" value="<%- t17 %>" id="t17" /> </div>\n    <div> t18:<input class="tinp" value="<%- t18 %>" id="t18" /> </div>\n    <div> t19:<input class="tinp" value="<%- t19 %>" id="t19" /> </div>\n    <div> t20:<input class="tinp" value="<%- t20 %>" id="t20" /> </div>\n    <p />\n\n    <div> t21:<input class="tinp" value="<%- t21 %>" id="t21" /> </div>\n    <div> t22:<input class="tinp" value="<%- t22 %>" id="t22" /> </div>\n    <div> t23:<input class="tinp" value="<%- t23 %>" id="t23" /> </div>\n    <div> t24:<input class="tinp" value="<%- t24 %>" id="t24" /> </div>\n    <div> t25:<input class="tinp" value="<%- t25 %>" id="t25" /> </div>\n\n    <div> t26:<input class="tinp" value="<%- t26 %>" id="t26" /> </div>\n    <div> t27:<input class="tinp" value="<%- t27 %>" id="t27" /> </div>\n    <div> t28:<input class="tinp" value="<%- t28 %>" id="t28" /> </div>\n    <div> t29:<input class="tinp" value="<%- t29 %>" id="t29" /> </div>\n    <div> t30:<input class="tinp" value="<%- t30 %>" id="t30" /> </div> \n    <p />\n    <div> t31:<input class="tinp" value="<%- t31 %>" id="t31" /> </div>\n    <div> t32:<input class="tinp" value="<%- t32 %>" id="t32" /> </div>\n    <div> t33:<input class="tinp" value="<%- t33 %>" id="t33" /> </div>\n    <div> t34:<input class="tinp" value="<%- t34 %>" id="t34" /> </div>\n    <div> t35:<input class="tinp" value="<%- t35 %>" id="t35" /> </div>\n\n    <div> t36:<input class="tinp" value="<%- t36 %>" id="t36" /> </div>\n    <div> t37:<input class="tinp" value="<%- t37 %>" id="t37" /> </div>\n    <div> t38:<input class="tinp" value="<%- t38 %>" id="t38" /> </div>\n    <div> t39:<input class="tinp" value="<%- t39 %>" id="t39" /> </div>\n    <div> t40:<input class="tinp" value="<%- t40 %>" id="t40" /> </div>\n    <p />\n\n    <div> t41:<input class="tinp" value="<%- t41 %>" id="t41" /> </div>\n    <div> t42:<input class="tinp" value="<%- t42 %>" id="t42" /> </div>\n    <div> t43:<input class="tinp" value="<%- t43 %>" id="t43" /> </div>\n    <div> t44:<input class="tinp" value="<%- t44 %>" id="t44" /> </div>\n    <div> t45:<input class="tinp" value="<%- t45 %>" id="t45" /> </div>\n\n    <div> t46:<input class="tinp" value="<%- t46 %>" id="t46" /> </div>\n    <div> t47:<input class="tinp" value="<%- t47 %>" id="t47" /> </div>\n    <div> t48:<input class="tinp" value="<%- t48 %>" id="t48" /> </div>\n    <div> t49:<input class="tinp" value="<%- t49 %>" id="t49" /> </div>\n    <div> t50:<input class="tinp" value="<%- t50 %>" id="t50" /> </div>\n    <p />\n\n</div>\n';
text_templates_daughterhtml = '<li><a href="#user/cowRead/<%- id %>"> <%- ear_num %></a> </li>\n';
models_cow = function (global, _, Backbone) {
  var CowModel = Backbone.Model.extend({
    ...
    fetchById: function (options) {
      var urlop = { url: this.url + this.attributes.id + '.json?redirect=sql2' };
      options = typeof optoins === 'undefined' ? urlop : _.extend(options, urlop);
      this.fetch(options);
    },
    fetch: function (options) {
  ...
  return CowModel;
}(global, underscore, backbone);
models_aiLog = function (global, _, Backbone) {
...
text_templates_ai_log_itemhtml = '<div> <div class="ai-log-item"><%- date %>:<%- state %></div></div>\n';
views_ai_log_item = function ($, _, Backbone, AiLogItemTemplate) {
  var CowNumberView = Backbone.View.extend({
    tagName: 'li',
    template: _.template(AiLogItemTemplate),
    events: { 'click .ai-log-item': 'navi2aiLogRead' },
    initialize: function () {
    },
    render: function () {
  ...
  return CowNumberView;
}(jquery, underscore, backbone, text_templates_ai_log_itemhtml);
text_templates_aiLogShowhtml = '<h1>AI\u30ED\u30B0</h1>\n\n<div id="log">\n  <ul">\n      <li>\u8033\u6A19\u756A\u53F7:<%- cow_no %></li>\n      <li>\u65E5\u4ED8:<%- date %>"</li>\n      <li>\u72B6\u614B:<%- state %>"</li>\n  </ul>\n</div>\n<div id="buttons"></dev>\n\n';
text_templates_aiLogEdithtml = '<h1>AI\u30ED\u30B0</h1>\n\n<div id="log">\n  <ul">\n      <li>\u8033\u6A19\u756A\u53F7:<%- cow_no %></li>\n      <li><input id="date" type="date" value="<%- date %>"/></li>\n      <li><input id="state" placeholder="" type="text" value="<%- state %>"/></li>\n  </ul>\n</div>\n<div id="buttons"></dev>\n\n';
views_aiLog = function ($, _, Backbone, ShowTemp, EditTemp, AiLog) {
  var AiLogView = Backbone.View.extend({
    el: 'div',
    templateS: _.template(ShowTemp),
    // Show Static: to read, delete
    templateE: _.template(EditTemp),
    // Edit: to create, update
    events: {
  ...
  return AiLogView;
}(jquery, underscore, backbone, text_templates_aiLogShowhtml, text_templates_aiLogEdithtml, models_aiLog);
views_cow = function ($, _, Backbone, cowTemp, cowTempE, daughterTemp, Cow, AiLogModel, AiLogItem, AiLog) {
  var CowView = Backbone.View.extend({
    ...
    events: {
      ...
      // Read
      'click #toDelete': 'navi2delete',
      // Read
      'click #toCowList': 'navi2CowList',
      // Read
      'click #save': 'saveModel',
      // Cread, Update
      'click #delete': 'deleteModel',
      // Delete
      'click #cancel': 'navi2cancel',
      // Cread, Update, Delete
    ...
    render: function () {
      ...
      if (_.find([
        ...
        var daughters = this.daughtersCollection.findWhere({ id: this.model.attributes.id });
        daughters = daughters ? daughters.attributes.daughters : [];
        daughters = _.sortBy(daughters, function (d) {
          return d.ear_num;
        });
        _.each(daughters, function (d) {
          if (this.kineCollection.get(d.id))
            $('#daughter-list').append(this.daughterTemplate(d));
          else
            $('#daughter-list').append('<li>' + d.ear_num + '</li>');
        }, this);
        _.each(this.logCollection.where({ cow_no: this.model.attributes.id }), function (a) {
          var view = new AiLogItem({ model: a });
          this.view_list.push(view);
          view.router = this.router;
          view.route = this.route;
        ...
        if (this.method === 'delete') {
          this.$('#button').append('[\u78BA\u8A8D]\u672C\u5F53\u306B\u524A\u9664\u3057\u3066\u3082\u3088\u3044\u3067\u3059\u304B\uFF1F' + '<input type="button" value="\u53D6\u308A\u6D88\u3057" id="cancel" />' + '<input type="button" value="\u524A\u9664" id="delete" />');
        } else if (this.method === 'read') {
          this.$('#button').append('<input type="button" value="\u524A\u9664" id="toDelete" />');
          this.$('#button').append('<input type="button" value="\u5909\u66F4" id="toUpdate" />');
          if (this.enableBackButton)
            this.$('#button').append('<input type="button" value="\u623B\u308B" id="back" />');
          this.$('#button').append('<input type="button" value="\u725B\u30EA\u30B9\u30C8\u3078" id="toCowList" />');
        }
    ...
    saveModelStep2: function () {
      this.navigate('next', this.method == 'create' ? '' : this.model.attributes.id);
    },
    deleteModel: function () {
      this.model.destroy();
      // it is not delete, destroy!
      this.navigate('next', '');
    },
    navi2cancel: function () {
      this.navigate('cancel', this.method == 'create' ? '' : this.model.attributes.id);
    },
    ...
    setNumerics: function () {
      this.$('#ear_num').numeric({
        decimal: false,
        negative: false
      });
      this.$('#owner_id').numeric({
        decimal: false,
        negative: false
      });
      this.$('#parent').numeric({
      ...
      this.$('#additional div input').numeric({
        decimal: false,
        negative: false
      });
    },
  ...
  return CowView;
}(jquery, underscore, backbone, text_templates_cowhtml, text_templates_cowEhtml, text_templates_daughterhtml, models_cow, models_aiLog, views_ai_log_item, views_aiLog);
 ...
 */
(function () {
  var S4, backboneSync, callbackTranslator, dualsync, getStoreName, localsync, modelUpdatedWithResponse, onlineSync, parseRemoteResponse, indexOf = [].indexOf || function (item) {
...
}.call(this));  //# sourceMappingURL=backbone.dualstorage.js.map
dualstorage = undefined;
collection_kine = function (_, Backbone, DualStorage, Cow) {
  var KineCollection = Backbone.Collection.extend({
    ...
    fetch: function (options) {
      ...
      options.url = server + this.url + '?search_owner=' + options.owner_id + '&redirect=sql';
      this.syncDirtyAndDestroyed();
      Backbone.Collection.prototype.fetch.call(this, options);
    }
  });
  return KineCollection;
}(underscore, backbone, dualstorage, models_cow);
collection_aiLogs = function (_, Backbone, DualStorage, aiLog) {
...
}(underscore, backbone, dualstorage, models_aiLog);
models_daughter = function (global, _, Backbone) {
  var DaughterModel = Backbone.Model.extend({
    ...
    fetch: function (options) {
      this.url = this.root + this.attributes.id + '.json' + '?redirect=on';
      Backbone.Model.prototype.fetch.call(this, options);
    }
  });
  return DaughterModel;
}(global, underscore, backbone);
collection_daughters = function (_, Backbone, Daughter) {
  ...
  var DaughtersCollection = Backbone.Collection.extend({
    ...
    fetch: function (options) {
      ...
      if (typeof options === 'undefined' || options.owner_id === '')
        return;
      options.url = server + this.url + '?redirect=on&search_owner=' + options.owner_id;
      Backbone.Collection.prototype.fetch.call(this, options);
    }
  });
  return DaughtersCollection;
}(underscore, backbone, models_daughter);
routers_router = function (global, $, _, Backbone, KineView, CowView, AiLogView, Kine, AiLogs, Daughters, Cow, AiLogModel, Daughter) {
  var KineRouter = Backbone.Router.extend({
    ...
    routes: {
      ...
      'user/cowDelete/:id': 'deleteCowView',
    ...
    postaction: function (view) {
      ...
      view.navigate = function (tag, opt) {
        ...
        if (typeof r == 'undefined')
          console.log('view.navigate : No route for the tag : ' + tag);
        if (r === '<==') {
          // imply to history back.
          history.back();
        } else {
          this.router.navigate(this.route[tag] + opt, { trigger: true });
        }
      };
    ...
    createCowView: function () {
      ...
      view.method = 'create';
      view.id = this.owner_id;
      // for backward compatibility.
      this.postaction(view);
    },
    showCowView: function (cow_id) {
      this.prepare('readCow', 'user/cowRead/');
      var cow = this.kineCollection.findWhere({ id: parseInt(cow_id) });
      if (!cow) {
        // never happen, I hope.
    ...
    deleteCowView: function (cow_id) {
      this.prepare('deleteCow', 'user/cowDelete/');
      var cow = this.kineCollection.findWhere({ id: parseInt(cow_id) });
      if (!cow) {
        // never happen, I hope.
        Backbone.history(this.next_route.back);
    ...
    readLogView: function (id) {
      ...
      if (!aiLog) {
        // never happen, unless you put id on address.
        Backbone.history(this.next_route.back);
        return;
      }
      var view = new AiLogView({ model: aiLog });
    ...
    loadCollections: function (callback) {
      ...
      this.listenToOnce(this.kineCollection, 'sync', this.loadCollectionsStep2);
    ...
    loadCollectionsStep2: function () {
      ...
      this.listenToOnce(this.logCollection, 'sync', this.loadCollectionsStep3);
    ...
    loadCollectionsStep3: function () {
      ...
      this.listenToOnce(this.daughtersCollection, 'sync', this.loadCollectionsCallback);
      this.daughtersCollection.fetch({ owner_id: this.owner_id });
    }
  });
  return KineRouter;
}(global, jquery, underscore, backbone, views_kine, views_cow, views_aiLog, collection_kine, collection_aiLogs, collection_daughters, models_cow, models_aiLog, models_daughter);
// require.config({
//   paths: {
//     jquery: 'libs/jquery',
...
}(backbone, routers_router));
mainsimple = undefined;
}());